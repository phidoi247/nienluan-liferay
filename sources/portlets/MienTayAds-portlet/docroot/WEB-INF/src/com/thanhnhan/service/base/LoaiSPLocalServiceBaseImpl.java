...
/**
 * Provides the base implementation for the loai s p local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.thanhnhan.service.impl.LoaiSPLocalServiceImpl}.
 * </p>
 *
 * @author ThanhNhan
 ...
 * @generated
 */
public abstract class LoaiSPLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements LoaiSPLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.thanhnhan.service.LoaiSPLocalServiceUtil} to access the loai s p local service.
	 */
	...
	@Override
	public LoaiSP addLoaiSP(LoaiSP loaiSP) throws SystemException {
		loaiSP.setNew(true);

		return loaiSPPersistence.update(loaiSP);
	}
	 ...
	 */
	@Override
	public LoaiSP createLoaiSP(long loaiSPId) {
		return loaiSPPersistence.create(loaiSPId);
	}
	...
	@Override
	public LoaiSP deleteLoaiSP(long loaiSPId)
		throws PortalException, SystemException {
		return loaiSPPersistence.remove(loaiSPId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LoaiSP deleteLoaiSP(LoaiSP loaiSP) throws SystemException {
		return loaiSPPersistence.remove(loaiSP);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LoaiSP.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return loaiSPPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return loaiSPPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return loaiSPPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return loaiSPPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public LoaiSP fetchLoaiSP(long loaiSPId) throws SystemException {
		return loaiSPPersistence.fetchByPrimaryKey(loaiSPId);
	}
	 ...
	 */
	@Override
	public LoaiSP getLoaiSP(long loaiSPId)
		throws PortalException, SystemException {
		return loaiSPPersistence.findByPrimaryKey(loaiSPId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return loaiSPPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LoaiSP> getLoaiSPs(int start, int end)
		throws SystemException {
		return loaiSPPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLoaiSPsCount() throws SystemException {
		return loaiSPPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LoaiSP updateLoaiSP(LoaiSP loaiSP) throws SystemException {
		return loaiSPPersistence.update(loaiSP);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.thanhnhan.model.LoaiSP",
			loaiSPLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.thanhnhan.model.LoaiSP");
	}
	...
	private LoaiSPLocalServiceClpInvoker _clpInvoker = new LoaiSPLocalServiceClpInvoker();
}