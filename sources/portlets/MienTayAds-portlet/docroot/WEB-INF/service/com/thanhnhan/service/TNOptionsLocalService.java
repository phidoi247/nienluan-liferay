...
/**
 * Provides the local service interface for TNOptions. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ThanhNhan
 * @see TNOptionsLocalServiceUtil
...
public interface TNOptionsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TNOptionsLocalServiceUtil} to access the t n options local service. Add custom service methods to {@link com.thanhnhan.service.impl.TNOptionsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
