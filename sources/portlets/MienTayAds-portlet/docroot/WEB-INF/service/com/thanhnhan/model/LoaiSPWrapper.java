...
public class LoaiSPWrapper implements LoaiSP, ModelWrapper<LoaiSP> {
	...
	*/
	...
	@Override
	public int compareTo(com.thanhnhan.model.LoaiSP loaiSP) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.thanhnhan.model.LoaiSP> toCacheModel() {
		return _loaiSP.toCacheModel();
	}

	@Override
	public com.thanhnhan.model.LoaiSP toEscapedModel() {
		return new LoaiSPWrapper(_loaiSP.toEscapedModel());
	}

	@Override
	public com.thanhnhan.model.LoaiSP toUnescapedModel() {
