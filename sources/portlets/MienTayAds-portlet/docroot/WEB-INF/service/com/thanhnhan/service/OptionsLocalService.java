...
/**
 * Provides the local service interface for Options. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ThanhNhan
 * @see OptionsLocalServiceUtil
...
public interface OptionsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OptionsLocalServiceUtil} to access the options local service. Add custom service methods to {@link com.thanhnhan.service.impl.OptionsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
