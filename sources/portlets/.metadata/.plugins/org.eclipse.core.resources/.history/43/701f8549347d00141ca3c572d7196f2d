...
import com.thanhnhan.service.TNOptionsService;
...
/**
 * Provides the base implementation for the t n options remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.thanhnhan.service.impl.TNOptionsServiceImpl}.
 * </p>
 *
 * @author ThanhNhan
 ...
 * @generated
 */
public abstract class TNOptionsServiceBaseImpl extends BaseServiceImpl
	implements TNOptionsService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.thanhnhan.service.TNOptionsServiceUtil} to access the t n options remote service.
	 */
	...
	private TNOptionsServiceClpInvoker _clpInvoker = new TNOptionsServiceClpInvoker();
}