...
/**
 * Provides the local service interface for SanPham. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ThanhNhan
 * @see SanPhamLocalServiceUtil
...
public interface SanPhamLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SanPhamLocalServiceUtil} to access the san pham local service. Add custom service methods to {@link com.thanhnhan.service.impl.SanPhamLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
