...
/**
 * Provides the local service interface for LoaiSP. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ThanhNhan
 * @see LoaiSPLocalServiceUtil
...
public interface LoaiSPLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LoaiSPLocalServiceUtil} to access the loai s p local service. Add custom service methods to {@link com.thanhnhan.service.impl.LoaiSPLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	/**
	* getAllLoais láº¥y táº¥t cáº£ loáº¡i sp
	*
	* @return
